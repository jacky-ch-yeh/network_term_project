...
time_label = w.create_text(50, 600, text="current time: ",
                           fill="black", font=('Arial 14 bold'), anchor='nw')
carNum_label = w.create_text(50, 630, text="current car number: ",
                             fill="black", font=('Arial 14 bold'), anchor='nw')
handoff_label = w.create_text(50, 660, text="handoff times: ",
                              fill="black", font=('Arial 14 bold'), anchor='nw')
